...
lazy val copyScalaJS = TaskKey[Unit]("copyScalaJS")

lazy val root = (project in file("."))
  .settings(
    copyScalaJS := {
      val file = new File(baseDirectory.value, "target/scala-2.12/scalajs-bundler/main/scalajs-gatsby-fastopt.js")
      Files.copy(file.toPath, new File("../gatsby/src/scalajs-gatsby-fastopt.js").toPath, StandardCopyOption.REPLACE_EXISTING)
    }
  )

addCommandAlias("bundle", ";fastOptJS::webpack;copyScalaJS")
